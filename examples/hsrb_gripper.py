...
def main():
    ...
    gripper_interface = GripperInterface(
        node=node,
        gripper_joint_names=hsrb.gripper_joint_names(),
        open_gripper_joint_positions=hsrb.OPEN_GRIPPER_JOINT_POSITIONS,
        closed_gripper_joint_positions=hsrb.CLOSED_GRIPPER_JOINT_POSITIONS,
        gripper_group_name=hsrb.MOVE_GROUP_GRIPPER,
