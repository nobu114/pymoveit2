...
- ros2 run pymoveit2 crane_plus_pose_goal.py --ros-args -p position:="[0.25, 0.0, 1.0]" -p quat_xyzw:="[0.0, 0.0, 0.0, 1.0]" -p cartesian:=False
- ros2 run pymoveit2 crane_plus_pose_goal.py --ros-args -p position:="[0.25, 0.0, 1.0]" -p quat_xyzw:="[0.0, 0.0, 0.0, 1.0]" -p cartesian:=False -p synchronous:=False -p cancel_after_secs:=1.0
- ros2 run pymoveit2 crane_plus_pose_goal.py --ros-args -p position:="[0.25, 0.0, 1.0]" -p quat_xyzw:="[0.0, 0.0, 0.0, 1.0]" -p cartesian:=False -p synchronous:=False -p cancel_after_secs:=0.0
"""
...
from pymoveit2.robots import crane_plus
...
def main():
    ...
    node = Node("crane_plus_pose_goal")

    # Declare parameters for position and orientation
    node.declare_parameter("position", [0.0, 0.0, 0.2])
    ...
    moveit2 = MoveIt2(
        node=node,
        joint_names=crane_plus.joint_names(),
        base_link_name=crane_plus.base_link_name(),
        end_effector_name=crane_plus.end_effector_name(),
        group_name=crane_plus.MOVE_GROUP_ARM,
